//! Existing-table transaction methods.
//!
//! This module contains methods that are only available on `Transaction<ExistingTable>`
//! (i.e. `Transaction` with the default type parameter). These operations require an
//! existing table and are not available on [`CreateTableTransaction`].
//!
//! Includes:
...
//!
//! [`CreateTableTransaction`]: super::create_table::CreateTableTransaction
...
// =============================================================================
// Existing-table-only: constructor
// =============================================================================
impl Transaction {
...
// =============================================================================
// Deletion vector schemas and helpers
// =============================================================================
...
// =============================================================================
// Deletion vector commit methods (shared across all transaction types)
// =============================================================================
