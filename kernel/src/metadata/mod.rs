...
struct ActionSchemas {
    ...
    add_partition_values_type: Arc<DataType>,
...
impl ActionSchemas {
    fn new() -> Self {
        ...
        #[allow(clippy::unwrap_used)]
        let add_partition_values_map_type = match &add_partition_values_type {
        ...
        Self {
            ...
            add_partition_values_type: Arc::new(add_partition_values_type),
...
fn flatten_scalar(scalar: &Scalar, output: &mut Vec<Scalar>) {
    match scalar {
        ...
        Scalar::Null(data_type) => {
            ...
            if let DataType::Struct(struct_type) = data_type.as_ref() {
