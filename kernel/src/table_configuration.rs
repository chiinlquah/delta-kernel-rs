    ...
    fn write_with_cdf() {
        ...
        let cases = [
            ...
            (
                ...
                Err(Error::unsupported(r#"Found unsupported TableFeatures: "columnMapping". Supported TableFeatures: "appendOnly", "changeDataFeed", "checkConstraints", "deletionVectors", "domainMetadata", "inCommitTimestamp", "invariants", "rowTracking", "timestampNtz", "variantType", "variantType-preview", "variantShredding-preview", "metadataTree-experimental""#)),
            ),
            (
