...
/// of op names (e.g. `STARTS_WITH`) and supplies the appropriate rewrites and scalar
/// evaluators. Ops outside that list opt out of every pruning pass; the engine is
...
impl OpaquePredicateOp for NamedOpaquePredicateOp {
    ...
    fn eval_pred_scalar(
        ...
        // Unrecognized op -- preserve the documented "no scalar eval" signal.
